...
\datedelement{\en{Supervisor}\fr{Directrice de recherche}}{\en{project “Researcher-entrepreneur” ICE}\fr{projet “Chercheur-entrepreneur” ICE}}{\en{"From natural to invented languages": supervision of a post-doctoral fellow (Dr Aurélie Nomblot), funded by Université Marie et Louis Pasteur, France, with the objective of technology transfer to a start-up.}\fr{"Des langues naturelles aux langues inventées~: génération automatique des langues immersives" : direction d'un contrat post-doctoral (Dr Aurélie Nomblot), financé par l'Université Marie et Louis Pasteur, France, avec l'objectif de transfert de technologie vers une start-up.}}{2025--2026}
...
\datedline{H. Ma-Bike Mundung, T. Dormieu, S. Diallo}{}{2026}

\datedline{M. Khaldi}{}{2025}

\datedline{L. Rodrigues De Almeida, J. Tadei, M. Potier, M. Mathie, Ch. Mensch, F. Montay}{}{2024}
...
\subsection{\en{Institutional responsibilities}\fr{Responsabilités institutionnelles}}

\datedelementdatefirst{06/2026--}{\en{AI Research Coordinator at the Faculty of Humanities (UFR SLHS)}\fr{Référente IA-recherche à l'UFR SLHS}}{}{Université Marie et Louis Pasteur, France.}

\datedelementdatefirst{04/2026--}{\en{Elected member of the Management Council of the Faculty of Languages Humanities (UFR SLHS)}\fr{Membre élue du Conseil de Gestion de l'UFR SLHS}}{}{Université Marie et Louis Pasteur, France.}

\datedelementdatefirst{06/2025--}{\en{Board Member of the Graduate School TRANSLATION (Humanities and Social Sciences)}\fr{Membre du directoire de l'Ecole Universitaire de Recherche (\textit{Graduate School}) TRANSLATION en SHS}}{}{Université Marie et Louis Pasteur, France.}
...
\datedelementdatefirst{04/2025--09/2025}{\en{Elected member of the Research Commission}\fr{Membre élue de la Commission de Recherche}}{}{Université Marie et Louis Pasteur, France.}
...
\datedelementdatefirst{09/2021--01/2026}{\en{Referent for Open Science}\fr{Référente pour la Science Ouverte}}{}{CRIT, Université Marie et Louis Pasteur, France.}
...
\datedelementdatefirst{09/2024--}{\en{Course manager of the specialty \textit{"Natural Language Processing (NLP)"}}\fr{Responsable du parcours \textit{"Traitement Automatique des Langues (TAL)"}}}{}{\en{BSc programmes, 4 modules of 6 ECTS}\fr{Licences LLCER et LEA, 4 modules de 6 ECTS}, Université Marie et Louis Pasteur, France.}
...
\datedelementdatefirst{2026}{\en{Member of the ANR AAPG evaluation panel}\fr{Membre du comité d'évaluation AAPG de l'ANR}}{}{Connect Talent - Vague 1 de la Région Pays de la Loire.}
...
\datedelementdatefirst{\en{Since}\fr{Depuis} 2025}{\en{Member of the editorial board of  International Journal on Digital Libraries (IJDL)}\fr{Membre du conseil éditorial de International Journal on Digital Libraries (IJDL)}}{, Springer}{\url{https://link.springer.com/journal/799}}
...
\begin{itemize}
    ...
    \item International Journal on Digital Libraries (IJDL): 2025, 2023, 2021, 2016
    \item Quantitative Science Studies (QSS): 2020
    \item Journal of Informetrics: 2017 (3), 2016, 2015
...
\begin{itemize}
	\item International Conference on AI, IoT, Embedded Technologies \& Sustainable Energy (AITEX 2026, \url{https://aitec-conf.com/}) - honorary chair 
	\item Asian Conference on Intelligent Information and Database Systems: 2026
	\item Workshop for Artificial Intelligence for Scientific Publications (WASP): 2025 
    \item SCOLIA 2025
    ...
    \item Conference of the International Society of Scientometrics and Informetrics (ISSI): 2025
    \item Doctoral Forum of the Conference of the International Society of Scientometrics and Informetrics (ISSI): 2025
   ...
   \item Workshop on Natural Language Processing for Digital Humanities (NLP4DH): 2025, 2022, 2021
...
{\textsc{\en{Organiser of "IUF dans le cartable"}\fr{Organisatrice de "IUF dans le cartable"}, Besançon, France, 2026}}

\fr{L'initiative "IUF dans le cartable"\footnote{Site web de l'évenement : \url{https://www.iufrance.fr/liuf-dans-le-cartable.html}.} vise à offrir à des lycéens l’opportunité de rencontrer et d’échanger de manière informelle avec des chercheurs de renommée internationale, venus de toute la France et membres de l'IUF. En créant un espace d’échanges hors des cadres classiques, nous cherchons à renforcer l'intérêt des lycéens pour la science et la recherche. En mars 2026, j'ai organisé la première édition à Besançon. Des lycéennes et lycéens venant de tous les 28 lycées généraux de l'académie de Besançon ont participé à ces rencontres.}
\en{The initiative "IUF dans le cartable" \textit{(IUF in the Backpack)}\footnote{Event website: \url{https://www.iufrance.fr/liuf-dans-le-cartable.html}.} aims to offer high school students the opportunity to meet and engage in informal conversations with internationally recognized researchers from across France, all members of the IUF (Institut Universitaire de France). By creating a space for dialogue outside of traditional academic settings, we seek to strengthen students' interest in science and research. In March 2026, I organize the first edition of the event in Besançon. Students from all 28 general high schools in the Besançon region take part in these exchanges.}
